...
public class WarehouseBossInterface extends JFrame implements ActionListener, KeyListener,ItemListener {
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getSource() == WbExit) {        //When exit button is pressed, warning message shows up.
      ...
      int diaResult = JOptionPane.showConfirmDialog(this,
          str,"Warning", JOptionPane.YES_NO_OPTION);
      ...
      //When the restart button is pressed, the game should go back to the start.
      ...
      String selectLevel = JOptionPane.showInputDialog(this,
          "Which level do you want to play ?","Level",JOptionPane.QUESTION_MESSAGE);
      Integer.parseInt(selectLevel);
  ...
  public class MyPanel extends JPanel {
    ...
    public void paint(Graphics g) {
      ...
      ArrayList<ArrayList<String>> currMap = game.getLevel(currLevel)
          .getMap();  //Get the map representing the current level that the player is on
