...
public class WarehouseBossInterface extends JFrame implements ActionListener {
  //We want to bulid interface with basic steps including
  //first pass, next level, previous level, last level and undo the last move;
  JButton WbFirst, WbNext, WbPre, WbFinal, WbUndo;

  //Then we can provide more actions like select which level gamer want to challenge
  ...
  class MyPanel extends JPanel {
    ...
    Image mapimg[]={
        ...
        kit.getImage("img/out-of-bounds.png"),
